...
public class Account {
	 ...
	 * @param balance
	 */
	public Account(int accountNumber, Customer owner, Date created, double balance) throws IDNotWellFormedException, InvalidAccountNumberException{
	 ...
	 * @param created
	 */
	public Account(int accountNumber, Customer owner, Employee manager, Date created)throws IDNotWellFormedException, InvalidAccountNumberException{
		this.accountNumber 	= setAccountNumber(accountNumber);
		this.owner			= new Customer(owner);
	 ...
	 * @param toCopy
	 */
	public Account (Account toCopy)throws IDNotWellFormedException, InvalidAccountNumberException{
		this.owner = toCopy.getOwner();
		this.accountManager = toCopy.getManager();
		this.dateCreated = toCopy.getDateCreated();
		this.accountNumber = setAccountNumber((int)toCopy.getAccountNumber());
	 ...
	 */
	public void setDateCreated(Date createdDate)throws IDNotWellFormedException{
	 ...
	 */
	public Customer getOwner() throws IDNotWellFormedException{
	 ...
	 * @param newOwner
	 */
	public void setOwner(Person newPerson, Date DOB, String custID)throws IDNotWellFormedException{
	...
	int setAccountNumber(int accntNum) throws InvalidAccountNumberException{
		if (accntNum < 10000 || accntNum > 99999){
			throw new InvalidAccountNumberException("\nAccount Number, " + accntNum + ", must be 5 digits: ");
		}
		return accntNum;
	}
